...
clc
% PARALLEL M-file for parallel.fig
...
% Last Modified by GUIDE v2.5 22-Mar-2017 09:54:45
...
%dt=get(handles.edit2,'String');
%c=get(handles.edit3,'String');
%fun=get(handles.edit5,'String');
%tf=get(handles.edit4,'String');
global b
global dt
global c
global fun
global tf
maxNumCompThreads(1);
[z1, t, y]=euler3(@func, fun, b, dt, c, tf);
z(1)=z1;
maxNumCompThreads(2);
[z1, t, y]=euler3(@func, fun,b , dt, c, tf);
z(2)=z1;
